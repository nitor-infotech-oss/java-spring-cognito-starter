...
public class AwsCognitoIdTokenProcessor {
    ...
    public Authentication authenticate(HttpServletRequest request) throws Exception {
        ...
        if (idToken != null) {
            ...
            String role = getRoleFrom(claims);
            if (username != null) {
    ...
    private String getRoleFrom(JWTClaimsSet claims) {
        Object roleClaims = claims.getClaims().get(this.jwtConfiguration.getRole());
        net.minidev.json.JSONArray stringValues = (net.minidev.json.JSONArray) roleClaims;
        return stringValues.get(0).toString();
    }
